...
savepath = '/net/airs1/storage/people/mgcy/Projects/VIIRS_Super_Resolution/ML_VI_Data_noLandsat_CO/'
    ...
    for year in range(start_year, end_year):
        ...
        while int(viirs_start_doy) <= 365:
            ...
            if VIIRS_FLAG:
                ...
                file = h5py.File(savepath + type + '.VI.' + year + '.' + str(viirs_start_doy) + '_no_Landsat.CO.h5', 'w')
...
make_ML_data(2021, 2024, type='Test_no_Landsat')
