...
viirspath = '/net/airs1/storage/people/mgcy/Projects/VIIRS_Super_Resolution/VIIRS_VI_CO/'
landsatpath = '/net/airs1/storage/people/mgcy/Projects/VIIRS_Super_Resolution/Landsat_VI_CO/'
savepath = '/net/airs1/storage/people/mgcy/Projects/VIIRS_Super_Resolution/ML_VI_Data_CO/'
...
landsat_start_doy_dict = {'2018':'18',
                  '2019':'5',
                  '2020':'8',
                  '2021':'10',
                  '2022':'13',
...
def make_ML_data(start_year, end_year, type='Train'):
    for year in range(start_year, end_year):
        ...
        while int(viirs_start_doy) <= 365:
            ...
            # load Landsat
            try:
                landsat_tmp = np.load(landsatpath + 'Landsat.VI.' + year + '.' + str(landsat_start_doy) + '.npy')
            except:
            ...
            if VIIRS_FLAG and LANDSAT_FLAG:
                ...
                file = h5py.File(savepath + type + '/VI.' + year + '.' + str(landsat_start_doy) + '.CO.h5', 'w')
...
make_ML_data(2021, 2024, type='Test')
