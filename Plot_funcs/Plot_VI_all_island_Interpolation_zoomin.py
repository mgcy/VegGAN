...
data = cv2.resize(data, (data.shape[1]*16, data.shape[0]*16), interpolation = cv2.INTER_LINEAR_EXACT)
print(data.shape)
...
ax1.set_title("(b) Zoom-in of Interpolated \n VIIRS EVI2 on Kauai")
...
ax2.set_title("(c) Zoom-in of Interpolated \n VIIRS EVI2 on Oahu")
...
ax3.set_title("(d) Zoom-in of Interpolated \n VIIRS EVI2 on Molokai")
...
ax4.set_title("(e) Zoom-in of Interpolated \n VIIRS EVI2 on Big Island")
...
plt.savefig(workpath + '/Plots/All_Islands_zoomin/Interpolation.EVI2.All.Islands.boxes.png', bbox_inches='tight', facecolor=(1, 1, 1, 0))
plt.close()
