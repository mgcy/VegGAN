...
data = cv2.resize(data, (data.shape[1]*16, data.shape[0]*16))
print(data.shape)
...
ax1.set_title("(a) Interpolated VIIRS EVI2")
...
plt.savefig(workpath + '/Plots/All_Islands_zoomin/Interpolation.EVI2.All.Islands.Geotif.png', bbox_inches='tight', facecolor=(1, 1, 1, 0))
plt.close()
