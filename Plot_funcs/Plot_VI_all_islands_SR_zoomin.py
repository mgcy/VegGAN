...
ax1.set_title("(b) Zoom-in of Downscaled \n EVI2 on Kauai")
...
ax2.set_title("(c) Zoom-in of Downscaled \n EVI2 on Oahu")
...
ax3.set_title("(d) Zoom-in of Downscaled \n EVI2 on Molokai")
...
ax4.set_title("(e) Zoom-in of Downscaled \n EVI2 on Big Island")
...
plt.savefig(workpath + '/Plots/All_Islands_zoomin/SR.EVI2.All.Islands.boxes.pdf', bbox_inches='tight', facecolor=(1, 1, 1, 0))
plt.close()
